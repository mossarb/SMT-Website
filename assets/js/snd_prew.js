...
$(document).on('click', '#sendBtn', function(e) {
    swal(
        'Başarılı',
        document.getElementById("validationCustomUsername").value + ' gönderisine ' + document.getElementById("validationCustom03").value + " görüntüleme işleminiz sıraya alınmıştır.",
        'success'
    )
});